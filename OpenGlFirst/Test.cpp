...
//	
//
//	// Pass the tranform matrix to the shader 
//	GLuint transormLoc = glGetUniformLocation(ourShader.Program, "transform");
//	glUniformMatrix4fv(transormLoc, 1, GL_FALSE, glm::value_ptr(trans));
//	
//    // Game loop
//    while (!glfwWindowShouldClose(window))
//    {
